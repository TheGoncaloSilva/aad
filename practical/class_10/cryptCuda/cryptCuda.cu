...
int main (int argc, char **argv)
{
  ...
  blockDimX = 1 << 0;                                             // optimize!  (sempre que aumentar aqui)
  blockDimY = 1 << 0;                                             // optimize!
  blockDimZ = 1 << 0;                                             // do not change!
  gridDimX = 1 << 21;                                             // optimize! (diminuir aqui linarmente)
  ...
  // compute the modified sector data on the CPU (use a for because of multiple computational units in CPU)
  (void) get_delta_time ();
                                      ...
                                      unsigned int sector_size)
{
 ...
 // modify the sector data (problema no atraso na memória, pq o acesso à memória global é muito lento)
