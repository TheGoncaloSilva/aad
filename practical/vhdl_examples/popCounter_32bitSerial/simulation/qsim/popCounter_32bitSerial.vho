...
-- pragma translate_on
PORT MAP (
	datac => \hd|hA10|xor20|ALT_INV_y~combout\,
...
PORT MAP (
	clk => \clk~inputCLKENA0_outclk\,
	asdata => \hd|hA11|xor20|y~combout\,
	clrn => \con|nad2|ALT_INV_y~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \hd|hA11|xor20|y~combout\ = ( \pr5|ff0|Q~DUPLICATE_q\ & ( !\pr5|ff1|Q~q\ $ (!\ff|Q~q\) ) ) # ( !\pr5|ff0|Q~DUPLICATE_q\ & ( \pr5|ff1|Q~q\ ) )
...
-- pragma translate_on
PORT MAP (
	datab => \hd|hA11|xor20|ALT_INV_y~combout\,
...
-- Equation(s):
-- \hd|hA12|xor20|y~combout\ = ( \ff|Q~q\ & ( \pr5|ff2|Q~q\ & ( (!\pr5|ff1|Q~q\) # (!\pr5|ff0|Q~q\) ) ) ) # ( !\ff|Q~q\ & ( \pr5|ff2|Q~q\ ) ) # ( \ff|Q~q\ & ( !\pr5|ff2|Q~q\ & ( (\pr5|ff1|Q~q\ & \pr5|ff0|Q~q\) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \hd|hA12|xor20|ALT_INV_y~combout\,
...
-- Equation(s):
-- \hd|hA13|xor20|y~combout\ = ( \ff|Q~q\ & ( \pr5|ff2|Q~q\ & ( !\pr5|ff3|Q~q\ $ (((!\pr5|ff1|Q~q\) # (!\pr5|ff0|Q~q\))) ) ) ) # ( !\ff|Q~q\ & ( \pr5|ff2|Q~q\ & ( \pr5|ff3|Q~q\ ) ) ) # ( \ff|Q~q\ & ( !\pr5|ff2|Q~q\ & ( \pr5|ff3|Q~q\ ) ) ) # ( !\ff|Q~q\ & ( 
...
-- pragma translate_on
PORT MAP (
	datab => \hd|hA13|xor20|ALT_INV_y~combout\,
...
-- Equation(s):
-- \hd|hA14|xor20|y~combout\ = ( \ff|Q~q\ & ( \pr5|ff4|Q~q\ & ( (!\pr5|ff1|Q~q\) # ((!\pr5|ff0|Q~q\) # ((!\pr5|ff2|Q~q\) # (!\pr5|ff3|Q~q\))) ) ) ) # ( !\ff|Q~q\ & ( \pr5|ff4|Q~q\ ) ) # ( \ff|Q~q\ & ( !\pr5|ff4|Q~q\ & ( (\pr5|ff1|Q~q\ & (\pr5|ff0|Q~q\ & 
-- (\pr5|ff2|Q~q\ & \pr5|ff3|Q~q\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	datac => \hd|hA14|xor20|ALT_INV_y~combout\,
...
-- Equation(s):
-- \hd|hA14|and20|y~combout\ = ( \pr5|ff1|Q~q\ & ( \ff|Q~q\ & ( (!\pr5|ff0|Q~DUPLICATE_q\) # ((!\pr5|ff2|Q~q\) # ((!\pr5|ff3|Q~q\) # (!\pr5|ff4|Q~q\))) ) ) ) # ( !\pr5|ff1|Q~q\ & ( \ff|Q~q\ ) ) # ( \pr5|ff1|Q~q\ & ( !\ff|Q~q\ ) ) # ( !\pr5|ff1|Q~q\ & ( 
-- !\ff|Q~q\ ) )
